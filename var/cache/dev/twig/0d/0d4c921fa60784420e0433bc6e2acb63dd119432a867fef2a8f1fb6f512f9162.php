...
class __TwigTemplate_e2d4ed4cef057e0ee308e265417e95c7e920b7d89db336ecc29ca5b9f1a14159 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('admin_delete', {'id': admin.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ admin.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "admin/_delete_form.html.twig", "C:\\wamp64\\www\\EGMS\\templates\\admin\\_delete_form.html.twig");
    }
}
