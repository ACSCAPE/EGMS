 ...
 */
class getEscapeGameRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EscapeGameRepository' shared autowired service.
     *
     * @return \App\Repository\EscapeGameRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EscapeGameRepository.php';

        return $container->privates['App\\Repository\\EscapeGameRepository'] = new \App\Repository\EscapeGameRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
